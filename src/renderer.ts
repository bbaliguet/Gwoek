...
function applyCellShadingStyle(context: CanvasRenderingContext2D): void {
...
function applyStandardStyle(context: CanvasRenderingContext2D, light = false): void {
...
function applyNoStyle(context: CanvasRenderingContext2D): void {
    context.lineWidth = 0;
    context.shadowBlur = 0;
    context.shadowOffsetX = 0;
...
function renderPrepare(context: CanvasRenderingContext2D, viewport: Viewport): void {
    context.clearRect(0, 0, viewport.width, viewport.height);
}

function renderPlayerPath(context: CanvasRenderingContext2D, viewport: Viewport, player: Player, ghost = false, onGround = false): Point {
...
function renderPlayer(context: CanvasRenderingContext2D, viewport: Viewport, stage: Stage, player: Player, ghost = false): void {
...
function renderGround(context: CanvasRenderingContext2D, viewport: Viewport, stage: Stage, background = false): void {
    ...
    ground.forEach(function (item: Tile, index: number) {
...
function renderBackground(context: CanvasRenderingContext2D, viewport: Viewport, stage: Stage): void {
...
export default function render(stage: Stage, dom: GameDOM): void {
